...
export async function buyCourse(
  ...
  //   console.log("andar aa gaya", courses);
  try {
    //load the script
    ...
    // console.log("order responce", orderResponse);
    ...
    const options = {
      ...
      handler: function (response) {
        ...
        console.log("Passing data to verifyPayment:", {
          ...response,
          courses,
        });
    ...
    paymentObject.on("payment.failed", function (response) {
      ...
      console.log("error ye raha", response.error);
    });
  } catch (error) {
